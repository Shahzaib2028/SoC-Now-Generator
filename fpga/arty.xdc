...
# set_property PACKAGE_PIN H5  [get_ports {io_gpio_io_31}]
# set_property PACKAGE_PIN J5  [get_ports {io_gpio_io_30}]
# set_property PACKAGE_PIN T9  [get_ports {io_gpio_io_29}]
# set_property PACKAGE_PIN T10 [get_ports {io_gpio_io_28}]
# set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_io_31}]
# set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_io_30}]
# set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_io_29}]
# set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_io_28}]
## RGB LEDs
# set_property PACKAGE_PIN E1 [get_ports { io_gpio_io_4 }]
#set_property PACKAGE_PIN F6 [get_ports { io_gpio_en_o[1] }]
#set_property PACKAGE_PIN G6 [get_ports { io_gpio_en_o[2] }]
#set_property PACKAGE_PIN G4 [get_ports { io_gpio_en_o[3] }]
#set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_en_o[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_en_o[1]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_en_o[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {io_gpio_en_o[3]}]

## Switches
#set_property PACKAGE_PIN A8 [get_ports { io_gpio_i[0] }]
#set_property PACKAGE_PIN C11 [get_ports { io_gpio_i[1] }]
#set_property PACKAGE_PIN C10 [get_ports { io_gpio_i[2] }]
#set_property PACKAGE_PIN A10 [get_ports { io_gpio_i[3] }]
#set_property IOSTANDARD LVCMOS33 [get_ports { io_gpio_i[0] }]
#set_property IOSTANDARD LVCMOS33 [get_ports { io_gpio_i[1] }]
#set_property IOSTANDARD LVCMOS33 [get_ports { io_gpio_i[2] }]
#set_property IOSTANDARD LVCMOS33 [get_ports { io_gpio_i[3] }]
...
#set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_i[1] }]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
#set_property -dict { PACKAGE_PIN C10   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_i[2] }]; #IO_L13N_T2_MRCC_16 Sch=sw[2]
#set_property -dict { PACKAGE_PIN A10   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_i[3] }]; #IO_L14P_T2_SRCC_16 Sch=sw[3]

## RGB LEDs
# set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_4 }]; #IO_L18N_T2_35 Sch=led0_b
# set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_5 }]; #IO_L19N_T3_VREF_35 Sch=led0_g
# set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_6 }]; #IO_L19P_T3_35 Sch=led0_r
# set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_7 }]; #IO_L20P_T3_35 Sch=led1_b
# set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_8 }]; #IO_L21P_T3_DQS_35 Sch=led1_g
# set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_9 }]; #IO_L20N_T3_35 Sch=led1_r
# set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_10 }]; #IO_L21N_T3_DQS_35 Sch=led2_b
# set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_11 }]; #IO_L22N_T3_35 Sch=led2_g
# set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_12 }]; #IO_L22P_T3_35 Sch=led2_r
# set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_13 }]; #IO_L23P_T3_35 Sch=led3_b
# set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_14 }]; #IO_L24P_T3_35 Sch=led3_g
# set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_15 }]; #IO_L23N_T3_35 Sch=led3_r

# set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_27 }]; #IO_L18N_T2_35 Sch=led0_b
# set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_26 }]; #IO_L19N_T3_VREF_35 Sch=led0_g
# set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_25 }]; #IO_L19P_T3_35 Sch=led0_r
# set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_24 }]; #IO_L20P_T3_35 Sch=led1_b
# set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_23 }]; #IO_L21P_T3_DQS_35 Sch=led1_g
# set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_22 }]; #IO_L20N_T3_35 Sch=led1_r
# set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_21 }]; #IO_L21N_T3_DQS_35 Sch=led2_b
# set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_20 }]; #IO_L22N_T3_35 Sch=led2_g
# set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_19 }]; #IO_L22P_T3_35 Sch=led2_r
# set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_18 }]; #IO_L23P_T3_35 Sch=led3_b
# set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_17 }]; #IO_L24P_T3_35 Sch=led3_g
# set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { io_gpio_io_16 }]; #IO_L23N_T3_35 Sch=led3_r
...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_o[0] }]; #IO_0_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_o[1] }]; #IO_L4P_T0_15 Sch=ja[2]
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_o[2] }]; #IO_L4N_T0_15 Sch=ja[3]
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_o[3] }]; #IO_L6P_T0_15 Sch=ja[4]
...
## Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_en_o[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_en_o[1] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_en_o[2] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { io_gpio_en_o[3] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
...
## Pmod Header JD
#set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { gpio_buf_0 }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
#set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { gpio_buf_1 }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
#set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { gpio_buf_2 }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
#set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { gpio_buf_3 }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
...
#set_property -dict { PACKAGE_PIN A9    IOSTANDARD LVCMOS33 } [get_ports { io_rx_i }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in
